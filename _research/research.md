...
This paper studies the equilibrium outcomes of alternative residential solar support policies within a nested discrete choice framework. Households endogenously determine whether to adopt solar photovoltaic and how much capacity to install, implying intensive effects of the policies. Furthermore, while adoption is always skewed to high-income groups, households respond heterogeneously to subsidy: switching from a subsidy based on future production to one that reduces upfront installation costs shifts solar photovoltaics adoption toward lower-income households, suggesting the feasibility of policy "sorting". The method of raising subsidy also shapes distributional outcomes, and the results depend on which dimension of inequality is considered. These findings highlight the importance of careful subsidy policy design.
